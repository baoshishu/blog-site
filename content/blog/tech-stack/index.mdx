...
[ChakraUI](https://chakra-ui.com/)， 优秀的 React UI 框架，基于 [System UI Theme Specification](https://system-ui.com/theme/) 的规范, 一个 _CSS in JS_ UI 框架的集大成者, 容易拓展。
...
- 很多漂亮使用的主题，推荐 [Night Owl](https://marketplace.visualstudio.com/items?itemName=sdras.night-owl]).
